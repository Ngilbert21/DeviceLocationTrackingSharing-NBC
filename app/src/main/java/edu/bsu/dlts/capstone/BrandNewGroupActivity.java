...
public class BrandNewGroupActivity extends AppCompatActivity {
     ...
     */
    private MobileServiceTable<Group> mPersonTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mClient = new MobileServiceClient(
                    ...
                    this).withFilter(new BrandNewGroupActivity.ProgressFilter());
            ...
            mPersonTable = mClient.getTable(Group.class);
    ...
    public Group addItemInTable(Group item) throws ExecutionException, InterruptedException {
        Group entity = mPersonTable.insert(item).get();
        return entity;
    }
